    ...
    <div class="product">
        <div :class="'product-inner ' + product.color">
            ...
            <div class="product-detail">
                <h2>{{ product.title }}</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit soluta quidem quaerat magni quis perspiciatis eum repudiandae suscipit eius voluptatibus?</p>
            </div>
        </div>
    </div>
</template>
